...
# data files
CFG['data'] = {}
CFG['data']['base_folder'] ='/Users/fatemehzamanzad/Desktop/limix/May/eQTL/data'
CFG['data']['gpfs_folder'] = '/Users/fatemehzamanzad/Desktop/limix/May/eQTL/data'
CFG['data']['expr_file']   = os.path.join(CFG['data']['base_folder'],'gex.h5')
...
# limix path
#CFG['limix_folder'] = '/nfs/research/stegle/users/casale/limix/limix1.3.1/build/release.linux2/interfaces/python'
